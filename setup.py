...
#
setup_keywords['name'] = 'kcwitools'
setup_keywords['description'] = 'Reduction and Analysis Software for KCWI'
setup_keywords['author'] = "Bordoloi and O'Meara"
setup_keywords['author_email'] = 'TBD'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/pypeit/kcwitools'
#
